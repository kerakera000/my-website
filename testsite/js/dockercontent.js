document.addEventListener("DOMContentLoaded", function(){
    ...
    let ClickBtnScssCardFront = document.getElementById("Click-btn-docker-card-front");
    let ClickBtnScssCardBehind = document.getElementById("Click-btn-docker-card-behind");
